    ...
    <div className='p-3 max-w-lg mx-auto'>
     ...
     <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
      ...
      <p className='text-sm self-center '>
        ...
        ( <span className='text-red-700'>Error Image upload(Image must be less than 2 bytes)</span> ) : 
      ...
      <input type='text'
       placeholder='email'
       defaultValue={currentUser.email} className='border p-3 rounded-lg' id='email'
       onChange={handleChange} />
     ...
     <p className='text-red-700 mt-5'>{showListingError ? 'Error showing in the listings' : ""}</p>
